    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item"> 
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ route('data_wbs') }}" aria-expanded="false"><i class="me-3 bi bi-people" aria-hidden="true"></i><span class="hide-menu">Data WBS</span></a></li>
